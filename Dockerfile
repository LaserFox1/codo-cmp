...
RUN mvn --batch-mode --no-transfer-progress -T 8 -DexcludeGroupIds=com.lkww.bitlog dependency:resolve-plugins dependency:resolve || echo "Dependency-resolve failed because https://issues.apache.org/jira/browse/MDEP-556. Ignoring for now..."
